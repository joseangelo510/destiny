-- Only one paid or demo audit may run for a website at a time.
create unique index audits_one_running_per_website_idx
...
begin
  ...
  set status = 'failed',
      progress = 100,
      completed_at = now(),
      failure_message = 'The previous audit exceeded the processing window. Please retry.'
