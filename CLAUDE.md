...
Follow root `HARNESS_POLICY.md`, GOV-1.5, owner decision D10.24.
...
Never claim a gate passed without a verifiable run URL. Preserve historical records; never present Codex review as another model's verdict.
