...
## D10.27 — Gmail sign-in recovery UX (2026-09-11 UTC)

Owner request, task 01a08dd5-6cf8-7a51-9849-0c30234bd5f5: "Okay, so we should look into that, right? Fix that."
Classification HIGH (authentication entry). Sole implementation owner Codex; base 95ecbd4921b80a688b3aee74b796d8a744259b93, clean dedicated codex/rebound-login-recovery worktree.
Confirmed production Auth logs: Gmail OTP accepted 02:59:47 UTC (200, b06f163e-40ab-4b7c-ac48-5183701e09b2); repeated requests rejected by over_email_send_rate_limit, including 03:00:03 UTC (429, 0825d97b-bf4c-4b79-bf6d-b730d9d57382, 42-second remaining wait). Existing generic error conceals cooldown. Gmail retains organization and 12 websites; contact address is a separate user with no membership.
Authorized implementation: typed cooldown guidance, safe countdown/retry controls, prevent duplicate pending submits, preserve email and safe destination across outcomes. Keep existing provider rate limits, session exchange, account creation behavior, RLS and memberships unchanged. No provider config, secrets, migrations or account merges. Verification: RED/GREEN action and rendered UX regressions, full harness and protected PR. Production merge/release approval remains separate for this new change. Rollback: protected revert of scoped login UI/actions after any authorized release. Status: implementation authorized; not merged or live.
