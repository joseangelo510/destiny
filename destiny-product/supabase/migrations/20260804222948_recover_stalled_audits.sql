-- A worker can be terminated by the hosted Edge Runtime before its catch block
-- runs. Recover audits whose durable progress has not moved for three minutes,
-- then allow the next onboarding submission to create a fresh audit.
