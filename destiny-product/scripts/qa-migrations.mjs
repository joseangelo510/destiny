...
const productionHistory = [
  ...
  "20260912204840_rebound_subscriptions.sql",
  "20260912210523_billing_operation_leases.sql",
  "20260912211309_billing_stripe_reconciliation.sql",
  "20260912214033_billing_work_stages.sql",
  "20260912215306_billing_rank_reservations.sql",
  "20260912220219_billing_rank_candidates.sql",
  "20260912221623_billing_audit_reservations.sql",
  "20260912222243_billing_free_audit_recovery.sql",
  "20260912222813_billing_onboarding_research.sql",
  "20260912233821_billing_tracking_activation.sql",
  "20260913161354_billing_managed_websites.sql",
  "20260913173007_billing_managed_reservations.sql",
  "20260913173338_billing_managed_tracking.sql",
  "20260913174021_billing_digest_candidates.sql",
  "20260913175248_billing_transactional_email_budget.sql",
  "20260913175720_billing_email_browser_denial.sql",
];
...
const remoteProductionHistory = [
  ...
  ["20260913204649", "rebound_subscriptions", "20260912204840_rebound_subscriptions.sql"],
  ["20260913204651", "billing_operation_leases", "20260912210523_billing_operation_leases.sql"],
  ["20260913204652", "billing_stripe_reconciliation", "20260912211309_billing_stripe_reconciliation.sql"],
  ["20260913204653", "billing_work_stages", "20260912214033_billing_work_stages.sql"],
  ["20260913204654", "billing_rank_reservations", "20260912215306_billing_rank_reservations.sql"],
  ["20260913204655", "billing_rank_candidates", "20260912220219_billing_rank_candidates.sql"],
  ["20260913204656", "billing_audit_reservations", "20260912221623_billing_audit_reservations.sql"],
  ["20260913204657", "billing_free_audit_recovery", "20260912222243_billing_free_audit_recovery.sql"],
  ["20260913204658", "billing_onboarding_research", "20260912222813_billing_onboarding_research.sql"],
  ["20260913204700", "billing_tracking_activation", "20260912233821_billing_tracking_activation.sql"],
  ["20260913204717", "billing_managed_websites", "20260913161354_billing_managed_websites.sql"],
  ["20260913204721", "billing_managed_reservations", "20260913173007_billing_managed_reservations.sql"],
  ["20260913204723", "billing_managed_tracking", "20260913173338_billing_managed_tracking.sql"],
  ["20260913204725", "billing_digest_candidates", "20260913174021_billing_digest_candidates.sql"],
  ["20260913204727", "billing_transactional_email_budget", "20260913175248_billing_transactional_email_budget.sql"],
  ["20260913204730", "billing_email_browser_denial", "20260913175720_billing_email_browser_denial.sql"],
];
