...
it("excludes disposable CLI runtime output while retaining application lint rules", async () => {
  ...
  expect(await lint.isPathIgnored("qa/artifacts/playwright-report/trace/assets/codeMirrorModule-rXmQmLUY.js")).toBe(true);
  expect(await lint.isPathIgnored("qa/e2e/billing.spec.ts")).toBe(false);
