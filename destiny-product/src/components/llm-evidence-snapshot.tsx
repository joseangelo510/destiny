...
export function LlmEvidenceSnapshot({ auditId, completedAt, now, status, websiteId }: {
  auditId: string | null;
  ...
  return <section className="workspace-card" aria-label="Provider snapshot context">
    ...
    {auditId ? <a href={siteScopedHref(`/audits/${auditId}`, websiteId)}>View the source audit</a> : null}
  </section>;
}
