...
describe("RoadmapExperience hierarchy", () => {
  it("leads with one Apple Clarity journey, one current position, and one next action", async () => {
    const roadmap = await buildSeoRoadmap({ auditComplete: true, quests: [
      ...
      { id: "reddit", title: "Answer a relevant Reddit thread", description: "Help someone with a useful answer.", action_path: "/distribution", task_type: "community_distribution", status: "todo", verification_status: "unverified", week_number: 5, priority: 4 },
    ...
    expect(html).toContain("1 of 4 tasks done");
