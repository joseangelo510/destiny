...
export function MonthCalendar({ data, emptyDayHref, websiteId, selectedKeyword }: { data: CalendarSummary; emptyDayHref?: string; websiteId?: string; selectedKeyword?: string }) {
