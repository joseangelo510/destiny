...
export function PublishingPlanManager({ websiteId, auditId, calendar, wordpressConnected, webflowConnected = false, approvedKeywordCount, websitePlatform, initialPlan, initialItems }: {
  websiteId: string;
  auditId: string;
