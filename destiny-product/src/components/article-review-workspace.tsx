  ...
  return <section className="article-review-workspace" id="article-review-workspace">
    ...
    <div className="article-editor workspace-card">
      <section className="article-generation-controls" aria-labelledby="article-generation-heading">
        ...
        {generating && <div className="configuration-note" role="status"><strong>{generationSeconds < 30 ? "Researching current sources" : generationSeconds < 90 ? "Writing the long-form draft" : "Finishing and checking the article"}</strong><p>A researched 2,000–2,200-word article can take a few minutes. {generationSeconds}s elapsed. You can cancel without losing the starter outline or your edits.</p></div>}
