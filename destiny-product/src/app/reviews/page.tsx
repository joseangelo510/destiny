...
import { reviewCountDisplay } from "@/lib/reviews/review-count-display";
...
export default async function ReviewsPage() {
  ...
  const reviewCount = reviewCountDisplay({ synced, count: businessMetadata.reviewCount });
