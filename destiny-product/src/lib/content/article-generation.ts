...
export const ARTICLE_FORMAT_OPTIONS = [
  { value: "seo_article", label: "SEO article", description: "A focused 2,000–3,000-word organic-search article." },
...
export function renderFeaturedImageSvg(title: string, keyword: string) {
  ...
  const titleSvg = lines.map((line, index) => `<text x="82" y="${210 + index * 78}" fill="#fbf2ee" font-family="Georgia, serif" font-size="62" font-weight="700">${escapeXml(line)}</text>`).join("");
  return `<svg xmlns="http://www.w3.org/2000/svg" role="img" aria-label="${escapeXml(`${title} featured image`)}" viewBox="0 0 1200 630" width="1200" height="630"><rect width="1200" height="630" fill="#241119"/><circle cx="1080" cy="72" r="250" fill="#9e1b40" opacity=".72"/><circle cx="1060" cy="590" r="310" fill="#f3bfd0" opacity=".18"/><rect x="82" y="90" width="86" height="8" rx="4" fill="#f3bfd0"/><text x="82" y="145" fill="#f3bfd0" font-family="Arial, sans-serif" font-size="25" font-weight="700" letter-spacing="3">REBOUND SEO GUIDE</text>${titleSvg}<text x="82" y="552" fill="#e6c9d5" font-family="Arial, sans-serif" font-size="25">${escapeXml(keyword.slice(0, 72))}</text><path d="M1015 215c43 0 78 35 78 78 0 66-78 143-78 143s-78-77-78-143c0-43 35-78 78-78Z" fill="#f3bfd0"/><circle cx="1015" cy="292" r="30" fill="#241119"/></svg>`;
}
